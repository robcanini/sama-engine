...
namespace core {
    ...
    private:
        ...
        static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
            auto app = reinterpret_cast<GameInstance*>(glfwGetWindowUserPointer(window));
        ...
        physics::ParticleWorld* generateWorld()
        {
			...
			GroundContacts* groundContactGen = new GroundContacts(&pWorld->getParticles(), -0.98f, 0.65f);
        ...
        void createGraphicsPipeline() {
            ...
            auto bindingDescription = vulkan::getBindingDescription();
            auto attributeDescriptions = vulkan::getAttributeDescriptions();
        ...
        void createComputeDescriptorSets() {
            ...
            for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
                ...
                storageBufferInfoLastFrame.range = sizeof(physics::Particle) * PARTICLE_COUNT;
                ...
                storageBufferInfoCurrentFrame.range = sizeof(physics::Particle) * PARTICLE_COUNT;
